import { Box, Container, RadioGroup, HStack, Radio, VStack, Text, Image, Stat, StatLabel, StatNumber, StatHelpText, StatArrow, Badge, Progress } from '@chakra-ui/react'
...
export default function CoinDetails() {
    ...
    if (error) {
        return (
            <Error message={"Error while Fetching Coin"}/>
        )
    }
